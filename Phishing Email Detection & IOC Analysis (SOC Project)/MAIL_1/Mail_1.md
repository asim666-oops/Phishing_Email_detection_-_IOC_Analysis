# Case 01 – Phishing Email Investigation (Mailgun Infrastructure Abuse)

## Case Summary
- **Threat Type:** Phishing
- **Severity:** High
- **Status:** Confirmed
- **Technique:** Email Spoofing + Redirect-Based URL Obfuscation
...
## Notes
- SPF, DKIM, DMARC: **FAIL**
- Redirect-based phishing confirmed via urlscan.io
- Threat validated using VirusTotal
